...
var LoginComponent = (function () {
    function LoginComponent(authService, router, flushMessage) {
        this.authService = authService;
        this.router = router;
        this.flushMessage = flushMessage;
    }
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flushMessage.show('You are now logged in', { cssClass: 'alert-success', timeout: 5000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flushMessage.show(data.msg, { cssClass: 'alert-danger', timeout: 5000 });
...
var NavbarComponent = (function () {
    function NavbarComponent(authService, router, flushMessage) {
        this.authService = authService;
        this.router = router;
        this.flushMessage = flushMessage;
    }
    ...
    NavbarComponent.prototype.onLogoutClick = function () {
        ...
        this.flushMessage.show('You are logged out', { cssClass: 'alert-success', timeout: 3000 });
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getPerofile().subscribe(function (profile) {
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, flushMessage, authService, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flushMessage.show('You are now registered', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flushMessage.show('Something went worng', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthService = (function () {
    ...
    AuthService.prototype.getPerofile = function () {
        this.loadToken();
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
